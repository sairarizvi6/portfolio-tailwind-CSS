    ...
    <div id="contact" className="pt-32 container">
      <div className="grid md:grid-cols-2 gap-10 md:gap-6">
        ...
        <div className="space-y-8">
          ...
          <p className="text-rose-100 text-[18px] pt-2" data-aos="zoom-in-up">
            Drop me a line, give me a call, or send me a message by submitting
            the form.
          </p>

          <div className="flex gap-3 items-center" data-aos="zoom-in-up">
            <AiOutlineMail size={30} /> <a href="mailto:xyz@gmail.com">sairarizvi6@gmail.com</a>
          </div>
          <div className="flex gap-3 items-center" data-aos="zoom-in-up">
            <BsTelephone size={30} /> <a href="tel:+920213062401306">+92 (021) 306-2401306</a>
          </div>
        </div>
